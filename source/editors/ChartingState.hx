...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['newDadDrainHealthValue', "Set Value 1 to be how much health BF loses when Dad (opponent) hits a note"],
		...
		['KB_AttackPrepare', "Plays the prepare animation for the sawblade. \nWill also call the alert event for you automatically! \n(Disable alert by setting value 1 to '0')\nSet value2 to '1' for first prepare\nof the song for visuals to work!!"],
